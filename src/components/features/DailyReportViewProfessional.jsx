        ...
        <div className="cover-content">
          <div className="cover-info-grid">
            ...
            <div className="info-box">
              ...
              <p className="info-value progress">
            ...
            <div className="page-header">
              ...
              <div className="header-right">
                <p className="header-meta">
                  Seite {pageIndex + 2} | {customer?.email || 'N/A'}
                </p>
              </div>
            </div>
                  ...
                  <div key={log.id} className="step-block">
                    <div className="step-header">
                      <div className="step-number">
                        <span
                          className={`step-badge ${log.status === 'completed' ? 'completed' : 'pending'}`}
                        >
                          {index + 1}
                        </span>
      ...
      <div className="protocol-page final-page">
        ...
        <div className="archive-section">
          <div className="archive-grid">
            ...
            <div className="archive-item">
              <label>Abgeschlossen</label>
              <span className="archive-value status-complete">
                {logs.filter(l => l.status === 'completed').length}
              </span>
            </div>
            <div className="archive-item">
              ...
              <span className="archive-value status-complete">
                {logs.filter(l => l.signature).length}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="document-footer">
          <p className="footer-text">Dieses Protokoll wurde automatisch von CleaniDoc generiert</p>
