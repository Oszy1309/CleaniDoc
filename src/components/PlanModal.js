...
const DEFAULT_STEPS = [
  { step_number: 1, step_name: 'Grobreinigung', cleaning_agent: 'none', dwell_time_minutes: 0, equipment: [] },
  { step_number: 2, step_name: 'Vorreinigung', cleaning_agent: 'water_only', dwell_time_minutes: 5, equipment: ['Lappen'] },
  { step_number: 3, step_name: 'Hauptreinigung (FM Plus)', cleaning_agent: 'fm_plus', dwell_time_minutes: 5, equipment: ['Mikrofasertuch'] },
  { step_number: 4, step_name: 'Bodenreinigung (Floor Ultra)', cleaning_agent: 'floor_ultra', dwell_time_minutes: 0, equipment: ['Lappen'] },
  { step_number: 5, step_name: 'Desinfektion (K Dis)', cleaning_agent: 'k_dis', dwell_time_minutes: 0, equipment: ['Mikrofasertuch'] },
];
  ...
  useEffect(() => {
    if (existingPlan) {
      ...
      if (existingPlan.steps && existingPlan.steps.length > 0) {
        setSteps(existingPlan.steps.map(step => ({
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          {/* CLEANING STEPS */}
          <div className="section-header" style={{ marginTop: '2rem' }}>Reinigungsschritte</div>
