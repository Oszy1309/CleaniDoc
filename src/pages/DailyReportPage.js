...
function DailyReportPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Hole alle Kunden und Bereiche für Filter
  ...
  return (
    <div className="daily-report-page">
      <div className="page-header">
        ...
        <p className="subtitle">Sammlung aller Reinigungsprotokolle für einen Tag</p>
      </div>
      ...
      <div className="controls-section">
        ...
        <div className="control-actions">
          ...
          <button
            ...
            title="Tagesprotokoll als PDF herunterladen"
          >
            <Download size={18} /> {generatingPDF ? 'PDF wird generiert...' : 'PDF exportieren'}
          </button>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div id="daily-report-content" style={{ display: generatingPDF ? 'block' : 'none' }}>
            <DailyReportView
              logs={filteredLogs}
              date={selectedDate}
              customers={customers}
